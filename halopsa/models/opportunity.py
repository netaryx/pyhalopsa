...
Opportunities use the same Faults_View / "tickets" key as Tickets,
with additional sales-pipeline fields.
"""
...
class Opportunity(HaloModel):
    """Full opportunity detail returned by single-get endpoints."""
    ...
    opportunityvalue: float | None = None
    probability: float | None = None
    weighted_value: float | None = None
    pipeline_id: int | None = None
    pipeline_stage_id: int | None = None
    expected_close_date: dt | None = None
    salesorder_id: int | None = None
